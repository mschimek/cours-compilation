...
struct n_instr_ {
  enum {incrInst, affecteInst, siInst, faireInst, tantqueInst, appelInst, retourInst, ecrireInst, ecrirecInst, videInst, blocInst, pourInst } type;  /* MODIFIE POUR EVAL*/
  union{
    n_exp *incr;
...
n_instr *cree_n_instr_ecrirec(n_exp *expression);
