...
void prarcourir_instr_ecrirec(n_instr * n);
...
void parcourir_instr(n_instr * n)
{
	...
	else if (n->type == ecrirecInst)
	    parcourir_instr_ecrirec(n);
...
void parcourir_instr_ecrirec(n_instr * n)
{
    char *fct = "instr_ecrirec";
